...
export const MitraTable: React.FC<MitraTableProps> = ({
  mitras,
  loading,
  onView,
  onEdit,
  ...
  return (
    <div className="border rounded-lg">
      <Table>
        ...
        <TableBody>
          {mitras.map((mitra) => (
            <TableRow key={mitra.id} className="hover:bg-muted/50">
              <TableCell>
                <div className="flex items-center gap-3">
                    ...
                    {mitra.img_url ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          target.src = `https://picsum.photos/200/150?random=${mitra.id}`;
                        }}
                      />
                    ) : (
